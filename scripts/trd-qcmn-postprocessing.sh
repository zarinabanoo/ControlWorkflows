...
QC_GEN_CONFIG_PATH='json://'`pwd`'/etc/trd-full-qcmn-postprocessing.json'
QC_FINAL_CONFIG_PATH='consul-json://{{ consul_endpoint }}/o2/components/qc/ANY/any/trd-qcm-full-postprocessing'
...
WF_NAME=trd-qcm-full-postprocessing
